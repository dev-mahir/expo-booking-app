  ...
  return (
    <SafeAreaView>
      <View style={{
        ...
        <TextInput value={input} onChangeText={(text) => setInput(text)} placeholder="Enter a search term" />
        <FontAwesome size={20} color={black} name="search" />

      </View>


      <SearchResult data={data} setInput={setInput} input={input} />
